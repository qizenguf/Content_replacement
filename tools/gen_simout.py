...
def generate_simout(jobid = None, resultsdir = None, partial = None, output = sys.stdout, silent = False):
  ...
  template += [
	('evicted bits', 'L3.evicted_bits', format_int),
	('optimal bits', 'L3.optimal_bits', format_int),
	('evicted is optimal', 'L3.evicted_is_optimal', format_int),
	('eviction times', 'L3.eviction_times', format_int),
	]
