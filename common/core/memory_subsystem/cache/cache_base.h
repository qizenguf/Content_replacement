...
class CacheBase
{
   ...
   public:
      ...
      CacheBase(String name, UInt32 num_sets, UInt32 associativity, UInt32 cache_block_size, CacheBase::hash_t hash, UInt32 cache_sector_size, AddressHomeLookup *ahl = NULL);
      virtual ~CacheBase();
