...
class CacheSet
{
   public:
      ...
      static CacheSet* createCacheSet(String cfgname, core_id_t core_id, String replacement_policy, CacheBase::cache_t cache_type, UInt32 associativity, UInt32 blocksize, UInt32 sectorsize, CacheSetInfo* set_info = NULL);
      ...
      static CacheBase::ReplacementPolicy m_policy;
   protected:
      CacheBlockInfo** m_cache_block_info_array;
      char* m_blocks;
      UInt32 m_associativity;
      UInt64 m_insert_addr;
      UInt32 m_blocksize;
      
      //UInt32 m_sectorsize;
      IntPtr accessing_tag;
      IntPtr accessing_para;
     // Lock m_lock;
   ...
   public:
      ...
      void insertwIndex(CacheBlockInfo* cache_block_info, Byte* fill_buff, bool* eviction, CacheBlockInfo* evict_block_info, Byte* evict_buff, int evicted_index, CacheCntlr *cntlr = NULL);
      void insert_Para(CacheBlockInfo* cache_block_info, Byte* fill_buff, bool* eviction, CacheBlockInfo* evict_block_info, Byte* evict_buff, int para, CacheCntlr *cntlr = NULL);
      bool isFull();
	UInt8 getReplacementInfo(UInt32 line_index);
