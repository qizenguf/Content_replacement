#ifndef CACHE_SET_BC_H
#define CACHE_SET_BC_H

#include "cache_set.h"

class CacheSetInfoBC : public CacheSetInfo
{
   public:
      CacheSetInfoBC(String name, String cfgname, core_id_t core_id, UInt32 associativity, UInt8 num_attempts);
      virtual ~CacheSetInfoBC();
...
class CacheSetBC : public CacheSet
{
   public:
      CacheSetBC(CacheBase::cache_t cache_type,
   ...
   protected:
      ...
      CacheSetInfoBC* m_set_info;
      void moveToMRU(UInt32 accessed_index);
};

#endif /* CACHE_SET_BC_H */
